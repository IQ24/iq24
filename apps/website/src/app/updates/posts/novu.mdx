...
summary: "iq24 is all about being on top of your business. Stay informed about your business insights, track when you get paid, receive updates on new transactions"
image: "/images/novu.png"
tag: "Engineering"
---

iq24 is all about being on top of your business. Stay informed about your business insights, track when you get paid, receive updates on new transactions, and access general information how your business actually are doing. And that includes well-timed notifications via emails and push notifications, carefully curated for your convenience.
...
```typescript
import { Notifications, Types, Events } from "@iq24otifications";
...
<br />
![iq24 - In App Notifications](/images/notification-center.gif)
<br />
Thanks to the SDK `@novu/headless` we implemented the notification center for iq24
...
<br />
![iq24 - In App Notifications](/images/notification-settings.gif)

<br />
### The future of iq24 x Novu
...
While this is just a draft on how we are using Novu in production you can dig deeper into the codebase in our [repository](https://git.new/iq24).
