...
Earlier this week [Dub.co](http://Dub.co) shared our [customer story](https://dub.co/customers/iq24) on why we choose Dub as our link-sharing infrastructure.
...
<br />
![iq24 - Overview](/images/overview.png)

<br />
If you look closely you can se our link looks like this: [https://go.iq24.ai/5eYKrmV](https://go.iq24.ai/5eYKrmV)
...
```typescript
const dub = new Dub({ projectSlug: "iq24" });
...
<br />
You can find the source code for this in our repository [here](https://github.com/iq24-ai/iq24/tree/main/apps/dashboard/src/actions/report).
