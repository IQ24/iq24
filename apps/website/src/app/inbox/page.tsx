      ...
      <div className="mb-40">
        ...
        <div className="flex items-center flex-col text-center relative">
          <p className="text-lg mt-4 max-w-[600px]">
            ...
            transaction suggestions from iq24. Easily search, reconcile and
      ...
      <div className="flex items-center flex-col text-center relative mt-28">
        <div>
          ...
          <p className="text-[#878787] text-sm">
            ...
            receipts.
            <br /> 2. The invoice arrives in the inbox, iq24 gives you a
        ...
        <CopyInput value="inbox.f3f1s@iq24.ai" className="max-w-[240px] mt-8" />
