      ...
      <div className="max-w-[600px] m-auto my-20">
        ...
        <div className="text-component line-height-lg v-space-md">
          ...
          <p className="leading-7 mt-8">
            ...
            your relationship with iq24 application (the "Service") operated by
            iq24 Labs AB ("us", "we", or "our").
          </p>

          <p className="leading-7 mt-8">
            Please read these Terms and Conditions carefully before using our
            iq24 application (the "Service").
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            cancel it or iq24 Labs AB cancels it. You may cancel your
            Subscription renewal either through your online account management
            page or by contacting iq24 Labs AB customer support team.
          </p>

          <p className="leading-7 mt-8">
            A valid payment method, including credit card, is required to
            process the payment for your Subscription. You shall provide iq24
            ...
            you automatically authorize iq24 Labs AB to charge all Subscription
            fees incurred through your account to any such payment instruments.
          </p>

          <p className="leading-7 mt-8">
            Should automatic billing fail to occur for any reason, iq24 Labs AB
          ...
          <p className="leading-7 mt-8">
            iq24 Labs AB, in its sole discretion and at any time, may modify the
          ...
          <p className="leading-7 mt-8">
            iq24 Labs AB will provide you with a reasonable prior notice of any
          ...
          <p className="leading-7 mt-8">
            Certain refund requests for Subscriptions may be considered by iq24
          ...
          <p className="leading-7 mt-8">
            ...
            "Copyright Infringement" of dmca@iq24.ai and include in your notice
          ...
          <p className="leading-7 mt-8">
            ...
            property of iq24 Labs AB and its licensors. The Service is protected
          ...
          <p className="leading-7 mt-8">
            ...
            that are not owned or controlled by iq24 Labs AB.
          </p>

          <p className="leading-7 mt-8">
            iq24 Labs AB has no control over, and assumes no responsibility for,
            the content, privacy policies, or practices of any third party web
            sites or services. You further acknowledge and agree that iq24 Labs
          ...
          <p className="leading-7 mt-8">
            In no event shall iq24 Labs AB, nor its directors, employees,
          ...
          <p className="leading-7 mt-8">
            iq24 Labs AB its subsidiaries, affiliates, and its licensors do not
