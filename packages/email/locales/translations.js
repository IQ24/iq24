    ...
    switch (locale) {
        case "en":
            return {
                ...
                "notifications.transactions": params?.numberOfTransactions &&
                ...
                "transactions.preview": `Hi ${params?.firstName}, You have ${params?.numberOfTransactions} ${params?.numberOfTransactions > 1
                    ? "new transactions"
                    : "new transaction"}`,
                ...
                "invite.subject": `${params?.invitedByName} invited you to the ${params?.teamName} team on iq24`,
                "invite.preview": `Join ${params?.teamName} on iq24`,
                "invite.title1": "Join",
                "invite.title2": "on",
        ...
        case "sv":
            return {
                ...
                "transactions.preview": `Hej ${params?.firstName}, Vi hittade ${params?.numberOfTransactions} ${params?.numberOfTransactions > 1
                    ? "nya transaktioner"
                    : "nya transaktion"} .`,
                ...
                "invite.subject": `${params?.invitedByName} bjöd in dig till ${params?.teamName} på iq24`,
                "invite.preview": `Gå med i ${params?.teamName} på iq24`,
