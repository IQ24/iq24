...
export function generateStaticParams() { 
  return Promise.resolve(
    [{"slug":["connection-expire"]},{"slug":["connection-issue"]},{"slug":["invite"]},{"slug":["invoice-comment"]},{"slug":["invoice-overdue"]},{"slug":["invoice-paid"]},{"slug":["invoice-reminder"]},{"slug":["invoice"]},{"slug":["transactions"]},{"slug":["welcome"]}]
  );
}