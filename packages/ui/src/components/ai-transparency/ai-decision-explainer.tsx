...
interface AIDecision {
  ...
  timestamp: Date
  agent: string
  category: 'lead_scoring' | 'message_generation' | 'timing_optimization' | 'channel_selection' | 'compliance_check'
      ...
      <CardHeader className="pb-4">
        <div className="flex items-start justify-between">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <CardTitle className="text-lg">AI Decision: {decision.decision}</CardTitle>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span className={cn("text-sm font-bold", getConfidenceColor(decision.confidence))}>
        ...
        <div className="space-y-3">
          ...
          >
            <span className="font-medium">Key Decision Factors ({decision.factors.length})</span>
              ...
              {decision.factors.map((factor, index) => (
                <div key={index} className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <span className={cn("text-xs", getImpactColor(factor.impact))}>
                        {factor.impact}
                      </span>
        ...
        {decision.alternatives && decision.alternatives.length > 0 && (
          <div className="space-y-3">
            <Button
              ...
              className="w-full justify-between p-0 h-auto"
            >
              <span className="font-medium">Alternative Options ({decision.alternatives.length})</span>
        ...
        {onFeedback && (
          <div className="flex items-center justify-between pt-4 border-t">
            <span className="text-sm font-medium">Was this decision helpful?</span>
            <div className="flex space-x-2">
              <Button
                variant={decision.userFeedback === 'positive' ? "default" : "outline"}
                size="sm"
              ...
              <Button
                variant={decision.userFeedback === 'negative' ? "destructive" : "outline"}
                size="sm"
...
export function AIDecisionExplainerExample() {
  const exampleDecision: AIDecision = {
    ...
    reasoning: "This lead shows high intent signals with recent website visits to pricing page, matches ideal customer profile, and has decision-making authority in her role as CTO.",
    factors: [
      {
        factor: "Intent Score",
        weight: 0.35,
    ...
    alternatives: [
      {
        ...
        score: 0.65,
        reasoning: "Lower urgency approach to avoid seeming pushy, but may miss current evaluation window"
      },
      {
        option: "Add to nurture campaign",
        score: 0.43,
        reasoning: "Safe option but likely to result in lost opportunity due to active evaluation signals"
      }
    ],
    outcome: 'pending',
    userFeedback: null
  ...
  const handleFeedback = (decisionId: string, feedback: 'positive' | 'negative') => {
