...
const mockTasks: HumanReviewTask[] = [
  {
    ...
    description:
      "AI generated email contains language that may trigger spam filters",
    priority: "high",
    aiAgent: "OPA",
  ...
  },
  {
    ...
    description:
      "Human marked lead as high-value, but AI scored as low-priority",
    priority: "medium",
    aiAgent: "PDA",
...
export function HumanInTheLoop() {
  ...
  const filteredTasks = tasks.filter((task) => {
    switch (activeTab) {
      ...
      case "completed":
        return ["approved", "rejected", "modified"].includes(task.status);
      default:
        return true;
    }
  });
                                ...
                                <Card>
                                  ...
                                  <CardContent className="space-y-4">
                                    ...
                                    <div>
                                      ...
                                      <div className="flex items-center space-x-2">
                                        <Progress
                                          value={selectedTask.aiConfidence}
                                          className="flex-1"
                                        />
                        ...
                        {task.status === "pending" && (
                          <div className="flex space-x-1">
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                handleTaskAction(task.id, { type: "approve" })
                              }
                            >
                            ...
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                handleTaskAction(task.id, { type: "reject" })
                              }
                            >
