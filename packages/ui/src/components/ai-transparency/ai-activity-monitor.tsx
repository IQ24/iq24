...
interface AIActivity {
  ...
  category: 'discovery' | 'validation' | 'personalization' | 'execution' | 'analysis' | 'compliance'
}
...
const getActivityIcon = (category: AIActivity['category']) => {
  switch (category) {
    ...
    case 'personalization': return <MessageSquare className="h-4 w-4" />
    ...
    <div className={cn("w-full space-y-6", className)}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h2 className="text-2xl font-bold tracking-tight">AI Activity Monitor</h2>
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div className="space-y-1">
                ...
                <p className="text-2xl font-bold">{metrics.runningActivities}</p>
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div className="space-y-1">
                ...
                <p className="text-2xl font-bold">{Math.round(metrics.averageExecutionTime)}s</p>
                <p className="text-xs text-muted-foreground">
      ...
      <div className="flex space-x-2">
        {(['all', 'running', 'completed', 'failed', 'queued', 'paused'] as const).map((status) => (
          <Button
            key={status}
              ...
              <div className="p-4 space-y-3">
                {filteredActivities.map((activity) => (
                  <div
                    ...
                    className={cn(
                      ...
                      selectedActivity === activity.id && "bg-muted ring-2 ring-primary"
                    )}
                ...
                {filteredActivities.length === 0 && (
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p className="text-sm">Activities will appear here when AI agents start working</p>
                  </div>
                )}
              </div>
            </ScrollArea>
                  ...
                  <div className="space-y-4">
                    <div className="grid gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{activity.agentName}</p>
                      </div>
                      <div>
                    ...
                    {activity.details.metrics && Object.keys(activity.details.metrics).length > 0 && (
                      <div>
                        <p className="text-sm font-medium mb-2">Metrics</p>
                        <div className="space-y-2">
                          {Object.entries(activity.details.metrics).map(([key, value]) => (
                    ...
                    {activity.details.logs && activity.details.logs.length > 0 && (
                      <div>
